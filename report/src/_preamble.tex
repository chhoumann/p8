...
\lstdefinelanguage{rust}
{
    ...
    keywords={
        ...
        break,continue,if,else,while,for,loop,match,return,yield,in,usize
    },
    keywordstyle=\color{Navy}\bfseries,
    ndkeywords={
        bool,u8,u16,u32,u64,u128,i8,i16,i32,i64,i128,char,str,
        Self,Option,Some,None,Result,Ok,Err,String,Box,Vec,Rc,Arc,Cell,RefCell,HashMap,BTreeMap,
        macro_rules,Mutex,Receiver,Uuid,ReceiverStream,SystemTime,TestRunnerWork,TestRunnerResult
    },
    ndkeywordstyle=\color{GoldDocumentation}\bfseries,
