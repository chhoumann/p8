...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{available_normal.png}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{available_schedule.png}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{available_qr.png}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{available_host}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{available_search.png}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{available_added.png}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{occupied_normal.png}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{occupied_extend.png}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{occupied_end_confirm.png}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{occupied_extend_2.png}
    \caption{The occupied view with the extend action open on the right side.}
