...
Incremental agile approaches have become popular to address this complexity.
These methods allows for fast adaptation to rapidly changing requirements and therefore faster development of software products where this is the case. \cite{sommervilleSoftwareEngineering2016}
...
Therefore, the team has decided on the agile framework Scrum\cite{scrumdotorg}. Scrum is chosen as it puts the values to practice and due to prior experience with using the framework amongst team members. \todo{What does it mean to put the values to practice}
...
To establish \text{how} the user story gets completed, an actionable plan for delivering the increment is made. This plan is produced during the start of each sprint in a process called \textbf{sprint planning}.
