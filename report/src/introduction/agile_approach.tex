...
Therefore, the team has decided on Scrum\cite{scrumdotorg}, which is an agile framework that puts the values to practice.\todo{What does it mean to put the values to practice}
