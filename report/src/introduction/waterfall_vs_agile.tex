...
Incremental agile approaches have become popular to address this complexity, as they allow for faster development and adaptation to changes.
This section will discuss the decision to use an agile approach for our project, focusing specifically on the Scrum framework.

\subsection*{Choosing an Agile Approach}
Based on a risk-based analysis developed by \Citeauthor{boehmObservationsBalancingDiscipline}, it is concluded that an agile approach is an appropriate process model for this project.
This conclusion is due to factors such as team size, project criticality, dynamism, personnel, and culture, which all lean towards an agile approach\cite{boehmObservationsBalancingDiscipline}.
