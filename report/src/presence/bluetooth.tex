...
Therefore, methods using Bluetooth for presence detection need to handle the effects of these obstructions such that suitable accuracy and precision are achieved.
