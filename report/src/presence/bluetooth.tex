\section{Presence detection using Bluetooth} \label{sec:bluetooth}
...
In the context of a system designed for the stakeholder, meeting rooms can be furnished with various objects.
Therefore, methods using Bluetooth for presence detection needs to handle the effects of these obstructions such that a suitable accuracy and precision is achieved.
