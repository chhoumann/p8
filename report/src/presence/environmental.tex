...
\begin{itemize}
    ...
    \item There is a time delay between the presence of a person and a noticeable increase in $\text{CO}_{2}$ concentration. The more people that are present, the shorter the time delay will be.\cite{gruberCO2SensorsOccupancy2014,longoAccurateOccupancyEstimation2019}
\end{itemize}
