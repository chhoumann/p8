...
Table \ref{lst:evaluated_technologies} summarizes the characteristic the covered technologies in terms of the choosen categories seen in Table \ref{lst:presence_eval_criteria}.
\begin{table}[]
    \centering
    \begin{center}
        \begin{tabular}{|l|l|l|l|l|p{30mm}|}
            \hline
            Technology/Metrics & Accuracy & Precision & Cost & Privacy & Environmental robustness \\ \hline
            Bluetooth          & x        & x         & x    & x       & x                      \\ \hline
            Wifi               & x        & x         & -    & x       & x                      \\ \hline
            CO2 sensors        & -        & -         & x    & x       & -                      \\ \hline
            Camera (regular)   & x        & x         & x    & -       & -                      \\ \hline
            Camera (infrared)  & x        & x         & -    & x       & x                      \\ \hline
        \end{tabular}
    \end{center}
    \caption{Summerized capabilities of the technologies using the metrics from Table \ref{lst:presence_eval_criteria}}
