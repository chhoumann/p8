...
Table xxx summarizes the characteristic the covered technologies in terms of the choosen categories seen in Table \ref(tab:evaluation_criteria).
\begin{table}[]
    \begin{tabular}{llllll}
    Technology/Metrics & Accuracy & Precision & Cost & Privacy & Environment robustness \\
    Bluetooth          & x        & x         & x    & x       & x                      \\
    Wifi               & x        & x         & -    & x       & x                      \\
    CO2 sensors        & -        & -         & x    & x       & -                      \\
    Camera (regular)   & x        & x         & x    & -       & -                      \\
    Camera (infrared)  & x        & x         & -    & x       & x                     
    \end{tabular}
\end{table}
