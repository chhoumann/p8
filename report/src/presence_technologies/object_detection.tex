...
This, combined with positioning and orientation of the camera, can be detremental to the quality of the data.\cite{granath_detecting_nodate}\cite{tang_occupancy_2020}
...
Moreover, because of these privacy concerns, acceptance and subsequent use of the system may be limited.\cite{granath_detecting_nodate}\cite{tang_occupancy_2020}\cite{PrivacyPreservingSensor}
