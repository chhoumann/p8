...
Having designed a prototype for a system meant to satisfy the stakeholders' requirements formed by user stories (see Section \ref{appendix:user_stories}), we can evaluate whether this system constitutes a suitable solution to the problematic situations described in Section \ref {sec:understanding_the_problem}.
