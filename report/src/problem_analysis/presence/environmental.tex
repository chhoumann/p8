...
Therefore, the environmental prerequisite for this approach is that the ventilation flow rate is rather constant, and the room is not exposed to a lot of outside air during measurements. This may be difficult to achieve in some environments, such as offices, where the ventilation flow rate is often not constant, and the room is exposed to a lot of outside air, given open windows or doors.
