...
% The classes \texttt{RssiDataCollector} and \texttt{RssiDataHandler} are responsible for invoking these events and managing the collection and processing of RSSI data, respectively.
...
% When the user initiates the data collection process, a countdown timer is displayed after which the data collection begins.
