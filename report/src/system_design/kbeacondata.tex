...
The \texttt{BitConverter} class, which is built into C\#, and visible in code snippet~\ref{lst:KBeaconData}, is used to convert data in a manner that is compatible with the endianness of the machine that it is running on. 
