...
These two values, which can be user-defined, allow further differentiation among beacons and can be used to group beacons by e.g. floor. We do not use these values in this system.
