...
In Table~\ref{lst:resultsPhone_precision}, we see that a lower $k$-value results in a greater uncertainty in the classifications.
...
Similarly, for all devices, when performing classification in locations \textit{H}, \textit{I}, \textit{J}, \textit{K}, and \textit{L}, the results are vastly different from the other locations.
