...
This can be understood by imagining a scenario where a person is located in position B (see Figure \ref{fig:experiment_setup}).
By having a beacon next by door, we risk that a slight fluctuation in the received signal strengh from the will result in the determined location of the person being that of the measurement point next to the door,immediatedly outside the room (see Figure \ref{fig:room_partition_beacons}).
